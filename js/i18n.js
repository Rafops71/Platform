...
const STRINGS = {
  en: {
    ...
    'terms.s10.p2': 'What is collected. When you accept an invitation and register, the Platform records your first name, last name, company, country, telephone number, email address, your password in securely hashed form, and your language preference. As you use the Platform it records the listings you publish, the messages you send and receive, the document declarations you make about a listing, and activity records such as sign-ins, approvals, invitations, and the version and language of the Terms you accepted.',
    ...
    'terms.s10.p4': 'Who can see it. Your identity and contact details are visible only to the Operators. Participants never see one another\'s identity: listings are published anonymously, and every message between Participants passes through an Operator, who decides what is passed on. No other Participant is shown your name, company, country, telephone number, or email address.',
  ...
  es: {
    ...
    'terms.s10.p2': 'Datos que se recogen. Al aceptar una invitación y registrarse, la Plataforma recoge su nombre, sus apellidos, su empresa, su país, su teléfono, su correo electrónico, su contraseña en forma cifrada y su preferencia de idioma. Durante el uso de la Plataforma se registran, además, las publicaciones que difunde, los mensajes que envía y recibe, las declaraciones documentales que realiza sobre cada publicación y los registros de actividad, como inicios de sesión, aprobaciones, invitaciones y la versión y el idioma de los Términos que aceptó.',
