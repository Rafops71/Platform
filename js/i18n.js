...
const STRINGS = {
  en: {
    ...
    'terms.s10.p5': 'Your data is not sold, rented, or traded, and it is not shared with third parties for their own purposes. It is disclosed only to the service providers used to run the Platform itself - hosting, database, and email delivery, named in the next paragraph - which act on the Operators\' instructions, and where the Operators are required to disclose it by law or need to do so to establish, exercise, or defend a legal claim.',
    'terms.s10.p6': 'Where your data is processed. The Platform runs on services provided by third parties, which act only on instructions given by the Operators: Supabase provides the database and the authentication system, Resend delivers the email the Platform sends, and GitHub Actions runs its scheduled tasks. The database is hosted in [PLACEHOLDER — database hosting region]. Email delivery and the scheduled tasks are carried out by providers established in the United States, so where the Platform emails you, your email address and the content of that message are transferred outside the United Kingdom and the European Economic Area. The safeguard relied on for that transfer is [PLACEHOLDER — international transfer safeguard, for example UK IDTA or EU Standard Contractual Clauses]. You may ask the Operators for details of these arrangements using the contact address below.',
    'terms.s10.p7': 'How long it is kept. Data is retained only for as long as it is needed to operate the Platform and to protect the Operators\' legal position, after which it is deleted or anonymised. Records that exist to evidence what was agreed - your acceptance of these Terms, and the audit trail of introductions made - are kept for as long as a claim arising from them could still be brought.',
    'terms.s10.p8': 'Operator access. The Operators may access all data held on the Platform, including listings, messages, and account details, for the purposes of brokerage and of security. This is inherent in how the Platform works: an Operator cannot introduce two Participants, or keep them anonymous to one another, without seeing what both have published and written.',
    'terms.s10.p9': 'Data controller. The controller responsible for your personal data is [PLACEHOLDER — data controller legal name], of [PLACEHOLDER — data controller registered address]. Questions about your data, and requests to access, correct, or delete it, should be sent to [PLACEHOLDER — data protection contact email address].',
    'terms.s10.p10': 'Complaints. If you believe your personal data has not been handled properly, you may raise it with the Operators using the contact details above, and you may complain to the competent supervisory authority, [PLACEHOLDER — competent data protection supervisory authority], at [PLACEHOLDER — supervisory authority address and contact details].',
